...
#     keypoints = TRAIN_DATA.get(image_id).get('keypoints')
#     bbox = TRAIN_DATA.get(image_id).get('bbox')
...
#     # save it to the json
#     TRAIN_DATA.get(image_id)['keypoints'] = keypoints
#     TRAIN_DATA.get(image_id)['bbox'] = bbox
